...
def initial(net, layers):
    for l in layers:
        k, m, _, _ = net.params[l][0].data.shape
        
        #net.params[l][0].data = 0
        # k = bg m!=object
        net.params[l][0].data[0, 0, :, :] = 1 
        net.params[l][0].data[0, 2, :, :] = 1
        
        # k = object m=object
        net.params[l][0].data[1:20, 1, :, :] = 1 
        
        # Else
        net.params[l][0].data[0, 1, :, :] = 0
        net.params[l][0].data[1:20, 0, :, :] = 0 
        net.params[l][0].data[1:20, 2, :, :] = 0     
